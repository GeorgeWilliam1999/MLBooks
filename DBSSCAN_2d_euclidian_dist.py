#DBSCAN is a clustering techinque that has two paremters, an epsilon and mean number of points
#DBSCAN does this by measuring the distance each point is from one another
#enough points are close enough together, then DBSCAN will classify it as a new cluster.
#Requires limited domain knowledge
#No knowledge of the number of clusters needed 
#Can find clusers of any shape

#Three essential types of point,

#Core:      Points that have the Min Points required within epsilon (including itself). 
#           These points along with border points will form a cluster.


#Border:    This is a point that has neighbors within epsilon but not enough neighbors to 
#           be a core point. These points make up the edge of the cluster.

#Noise:     This is a point that does not have enough neighbors within epsilon 
#           to be part of a cluster (including itself).
